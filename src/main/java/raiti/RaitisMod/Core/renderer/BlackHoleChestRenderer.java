package raiti.RaitisMod.Core.renderer;
...
import raiti.RaitisMod.Core.renderer.model.BlackHoleChestModel;

import java.nio.FloatBuffer;
import java.util.Random;

/**
 * Created by Raiti-chan on 2016/11/13.
 *
 * @author Raiti-chan
 */
public class BlackHoleChestRenderer extends TileEntitySpecialRenderer {
	private static final ResourceLocation TEXTURE_END_SKY = new ResourceLocation("raitismod:textures/environment/end_sky.png");
	private static final ResourceLocation TEXTURE_END_PORTAL = new ResourceLocation("raitismod:textures/entity/end_portal.png");
	private static final ResourceLocation TEXTURE_MODEL = new ResourceLocation("raitismod:textures/model/blackhole_chest.png");
